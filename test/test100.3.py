...
def classify_rhythm(rr_intervals_sec, heart_rate_bpm):
    ...
    # Assuming rr_std is the standard deviation of RR intervals, indicating variability
    if rr_variability > 0.1 and heart_rate_bpm > 100:
        return "Tachyarrhythmia"  # High heart rate with high variability
    elif rr_variability > 0.1:
        return "Fibrillation"  # High variability might indicate fibrillation
    else:
        return "Normal"
